						...
						<div class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									...
									<input type="text" class="form-control" name="author_name" id="email"  placeholder="Enter Author Name"/>
								</div>
							</div>
						</div>

						<div class="form-group">
							<label for="publication" class="cols-sm-2 control-label">Publication</label>
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-users fa" aria-hidden="true"></i></span>
									<input type="text" class="form-control" name="publication" id="username"  placeholder="Enter your Publication"/>
								</div>
							</div>
						</div>
							...
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-bars" aria-hidden="true"></i></span>
								      <select class="form-control" name="subject" id="username"  placeholder="Enter Subject"/>
                      ...
                      while(rs.next())
						...
						<div class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									...
									<input type="text" class="form-control" name="edition" id="username"  placeholder="Enter Edition"/>
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-users fa" aria-hidden="true"></i></span>
									<input type="text" class="form-control" name="price" id="username"  placeholder="Enter Price"/>
								</div>
							</div>
						</div>
                                                    ...
                                                    <div class="form-group">
                                                            ...
                                                            <div class="cols-sm-10">
                                                                    <div class="input-group">
                                                                            <span class="input-group-addon"><i class="fa fa-lock fa-lg" aria-hidden="true"></i></span>
                                                                            <input type="text" class="form-control" name="ISBN" id="username"  placeholder="Enter ISBN Number"/>
                                                                    </div>
                                                            </div>
                                                    </div>
							...
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-lock fa-lg" aria-hidden="true"></i></span>
									<select name="standard" placeholder="Standard"><option>6</option>
                                                                            <option>7</option>
                                                                            <option>8</option>
                                                                            <option>9</option>
                                                                            <option>10</option>
						  ...
						  <input type="file" name="url"></input>
                                        ...
                                        <div class="form-group ">
							<input type="submit" id="button" class="btn btn-primary">Register</a>
						</div>
