<%-- 
    Document   : contact
    Created on : 24 Sep, 2017, 3:00:30 PM
    Author     : pc
--%>
		...
		<nav class="navbar navbar-default navbar-left" role="navigation">
		    ...
		    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		      <ul class="nav navbar-nav">
		        ...
		        <li><a href="book_details.jsp">Books</a></li>
		        <li><a href="blog.html">Donate</a></li>
				<li><a href="buy_books.jsp">Receive</a></li>
	...
	<div class="container">
		<div class="main row">
			    <div class="col-md-4 company_ad">
				    <h2>find Address :</h2>
      				<address>
						 <p>Chandigarh College Of Engg. and Technology</p>
						 <p>Sector-26,Chandigarh</p>
						 <p>INDIA</p>
				   		<p>Phone:(00) 222 666 444</p>
				   		<p>Fax: (000) 222 666 444</p>
				 	 	<p>Email: <a href="narulashubham09@gmail.com">info(at)mycompany.com</a></p>
