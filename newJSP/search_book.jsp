	...
	<br><br>
			...
			<center><h5><b>LETS DONATE FOR NOBEL CAUSE</h5></center></h5></b><br>
                ...
                <form method="post" action="show.jsp">
					<div class="form-group"> 
							<label for="book_name" class="cols-sm-2 control-label">Enter the subject</label>
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-user fa" aria-hidden="true"></i></span>
									<input type="text" class="form-control" name="book_name" id="name"  placeholder="Enter subject Name"/>
						...
						<div class="form-group">
						<label for="standard" class="cols-sm-2 control-label">Enter the standard</label>
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-user fa" aria-hidden="true"></i></span>
									<input type="text" class="form-control" name="standard" id="name"  placeholder="Enter standard"/>
