...
<form method="post" action="book_details1.jsp">
    <h2><center>Books according to your search are:</center><h2>
...
<td><input  href=""  id="button"  class="btn btn-primary btn-lg btn-block login-button" type="submit" name="id" value="<%=i.getString(1)%>"> </td>
           </tr><%}%></table></center>
